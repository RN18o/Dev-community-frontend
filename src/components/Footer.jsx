    ...
    return (
        <footer className="flex flex-col md:flex-row bg-base-300 text-neutral-content items-center justify-around p-4 gap-4">
            <div className="flex items-center gap-2">
                ...
                <span className="text-white text-xl">Dev-Community</span>
            </div>
            <aside className="flex flex-col items-center text-center">
                <p>Dev-Community - Connecting Developers since 2025</p>
            ...
            <nav>
                <div className="grid grid-flow-col gap-4">
                    <a href="https://www.linkedin.com/in/aryan006/" target="_blank" rel="noopener noreferrer">
                        <svg
                    ...
                    <a href="https://github.com/RN18o?tab=repositories" target="_blank" rel="noopener noreferrer">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
