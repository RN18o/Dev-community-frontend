      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-base-200 shadow-md border border-gray-700 rounded-lg p-6">
          <section className="mb-8">
            ...
            <p className="mb-4">
              DevCommunity is a digital platform designed to connect developers.
              As such, we do not offer or deal in physical products that require
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              DevCommunity platform. There are no delivery times or shipping
          ...
          <section>
            ...
            <p className="mt-2 mb-4">Email: devCommunity6@gmail.com</p>
          </section>
        </div>
      </div>
    </div>
