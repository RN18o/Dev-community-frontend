...
function Chat() {
  ...
  const sendMessage = () => {
    ...
    if (newMessages.trim() === "" || !socket || !user || !user.firstName)
      return;
      ...
      <div className="p-4 border-b border-base-300 flex items-center gap-4 bg-base-300 rounded-t-lg">
        <div className="avatar">
          <div className="w-12 rounded-full">
            <img src={targetUser?.photoUrl} alt="Chat partner" />
          </div>
        </div>
        <div>
        ...
        {messages.map((msg, index) => {
          ...
          return (
            <Fragment key={index}>
              ...
              <div
                className={`chat ${
                  msg.from === "me" ? "chat-end" : "chat-start"
                }`}
              >
                  ...
                  <div className="w-10 rounded-full">
                    <img
                      alt={`${
                        msg.from === "me"
                          ? "Your"
                          : targetUser?.firstName || "Chat partner"
                      }'s avatar`}
                      src={
                        msg.from === "me"
                          ? user?.photoUrl
