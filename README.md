# Dev-Community Frontend

## 🚀 Overview

**Dev-Community** is a MERN stack application where developers can create profiles, send connection requests, and connect with each other, similar to a networking platform. This repository contains the frontend for Dev-Community.

## 🛠 Tech Stack

- **Frontend:** React.js, Vite, Redux Toolkit, Tailwind CSS
- **State Management:** Redux Toolkit
- **Backend:** [Dev-Community backend](https://github.com/RN18o/Dev-community-backend)
- **Authentication:** JWT
...
```sh
git clone https://github.com/RN18o/Dev-community-frontend.git
```
...
The frontend interacts with the backend API hosted in the [Dev-Community-backend](https://github.com/RN18o/Dev-community-backend). Ensure the backend is running before using the frontend.
